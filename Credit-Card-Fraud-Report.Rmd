...
rf_cm <- confusionMatrix(rf_predictions, factor(validation_set$Class))
```
...
The results of this model can be found in the table below. The results produced a low specificity of less than 67% and a perfect sensitivity of 100%. This means that we classified more than 30% of the fraudulent transactions as non-fraudulent, which does not meet our objective. 
```{r, echo=FALSE, include=TRUE}
